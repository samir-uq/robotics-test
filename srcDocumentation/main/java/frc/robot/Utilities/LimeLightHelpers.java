...
/// Limelight helpers is a utility class developed by the makers of Limelight to make it easier to use.
/// You do not need to understand this file, just understand how limelights and vision work.
...
public class LimeLightHelpers {
    ...
    public static Object RawFiducial;
    ...
    private static Pose2d getTargetPose(String limelightName, String entryName) {
    ...
    public static Pose2d getTargetPose_wpiBlue(String limelightName) {
        return getTargetPose(limelightName, "botpose_wpiblue");
    }
